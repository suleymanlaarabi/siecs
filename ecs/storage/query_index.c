...
static inline void ecs_query_from_desc(const ecs_query_desc_t *desc, ecs_query_t *query) {
    int i = 0;
...
void ecs_query_index_update_matches(ecs_query_index_t *index, const ecs_table_t *tables, uint16_t table_count, uint32_t query) {
