...
typedef void (*ecs_component_on_add_t)(ecs_world_t *world, ecs_entity_t entity,
 ...
 */
typedef void (*ecs_component_on_set_t)(ecs_world_t *world, ecs_entity_t entity,
                                       ecs_component_t component,
                                       const void *new_value,
                                       void *current_value);

/* Called before a component slot is removed. */
typedef void (*ecs_component_on_remove_t)(ecs_world_t *world,
                                          ecs_entity_t entity,
                                          ecs_component_t component,
                                          void *value);
...
SIECS_API ecs_world_t *
ecs_init_w_features(const ecs_world_feat_desc_t *features);
...
#define ECS_MODULE_DECLARE(module_name, ...)                                   \
  ...
  void ecs_id(module_name##_import_wrapper)(ecs_world_t * world,               \
                                            const void *desc);                 \
  void module_name##_import(ecs_world_t *world,                                \
                            const module_name##_props_t *props)
...
#define ecs_module(world, ...)                                                 \
  ecs_module_init(world, &(ecs_module_desc_t)__VA_ARGS__)

/* Register/import a module descriptor and return its module id. */
SIECS_API ecs_module_id_t ecs_module_init(ecs_world_t *world,
                                          const ecs_module_desc_t *desc);
 ...
 */
SIECS_API ecs_module_id_t ecs_module_find(ecs_world_t *world,
                                          const ecs_module_id_t *id);
...
SIECS_API bool ecs_module_is_enabled(const ecs_world_t *world,
...
SIECS_API ecs_component_t ecs_component_init(ecs_world_t *world,
                                             const ecs_component_desc_t *desc);

/* Register a typed component descriptor using stable process-wide id storage.
 */
SIECS_API ecs_component_t ecs_component_register(
    ecs_world_t *world, ecs_component_t *id, const ecs_component_desc_t *desc);
...
SIECS_API void ecs_is_a(ecs_world_t *world, ecs_entity_t entity,
                        ecs_entity_t target);
...
SIECS_API uint32_t ecs_query_init(ecs_world_t *world,
 ...
 */
SIECS_API void ecs_add_cid(ecs_world_t *world, ecs_entity_t entity,
                           ecs_component_t id);

/* Remove a typed component from an alive entity. */
#define ecs_remove(world, entity, cname)                                       \
  ecs_remove_cid(world, entity, ecs_id(cname))
 ...
 */
SIECS_API void ecs_remove_cid(ecs_world_t *world, ecs_entity_t entity,
                              ecs_component_t id);
...
SIECS_API bool ecs_has_cid(const ecs_world_t *world, ecs_entity_t entity,
                           ecs_component_t id);
bool ecs_has_cid_owned(const ecs_world_t *world, ecs_entity_t entity,
                       ecs_component_t id);
 ...
 * absent.
 */
#define ecs_get(world, entity, cname)                                          \
  ((cname *)ecs_get_cid(world, entity, ecs_id(cname)))
 ...
 */
SIECS_API void *ecs_get_cid(ecs_world_t *world, ecs_entity_t entity,
                            ecs_component_t id);

/* Get a typed component pointer, or NULL if the entity does not have it. */
#define ecs_try_get(world, entity, cname)                                      \
  ((cname *)ecs_try_get_cid(world, entity, ecs_id(cname)))

/* Get a component pointer by id, or NULL if the entity does not have it. */
SIECS_API void *ecs_try_get_cid(ecs_world_t *world, ecs_entity_t entity,
                                ecs_component_t cid);
 ...
 * if needed.
 */
SIECS_API void ecs_set_cid(ecs_world_t *world, ecs_entity_t entity,
                           ecs_component_t id, const void *data);
...
#define ecs_get_resource(world, rname)                                         \
  ((rname *)ecs_resource_rid(world, ecs_id(rname)))
#define ecs_get_resource_read(world, rname)                                    \
  ((const rname *)ecs_resource_rid(world, ecs_id(rname)))

/* Get a world resource, or NULL if it does not exist. */
#define ecs_try_get_resource(world, rname)                                     \
  ((rname *)ecs_try_resource_rid(world, ecs_id(rname)))
...
#define ecs_has_resource(world, rname)                                         \
  ecs_has_resource_rid(world, ecs_id(rname))

/* Remove a world resource if it exists. */
#define ecs_remove_resource(world, rname)                                      \
  ecs_remove_resource_rid(world, ecs_id(rname))
...
#define ecs_try_resource_read(world, rname)                                    \
  ecs_try_get_resource_read(world, rname)

SIECS_API ecs_resource_t ecs_resource_init(ecs_world_t *world,
                                           const ecs_resource_desc_t *desc);
SIECS_API ecs_resource_t ecs_resource_find(ecs_world_t *world,
                                           const char *name);
SIECS_API bool ecs_resource_is_registered_rid(const ecs_world_t *world,
                                              ecs_resource_t id);
SIECS_API void ecs_set_resource_rid(ecs_world_t *world, ecs_resource_t id,
                                    const void *data);
...
SIECS_API bool ecs_has_resource_rid(const ecs_world_t *world,
                                    ecs_resource_t id);
 ...
 */
SIECS_API void ecs_with(ecs_world_t *world, ecs_component_t component,
...
SIECS_API ecs_observer_id_t ecs_observer_init(ecs_world_t *world,
 ...
 */
SIECS_API void ecs_observer_trigger(ecs_world_t *world, ecs_entity_t entity,
                                    ecs_event_t event,
                                    const void *trigger_data);
 ...
 *   }
 */
SIECS_API ecs_iter_t ecs_query_iter(ecs_world_t *world,
...
SIECS_API ecs_system_id_t ecs_system_init(ecs_world_t *world,
