...
int main() {
    ...
    ecs::entity::create("Camera").set(
        Position3d{ 0.0f, 3.5f, 14.0f },
        Rotation3d{ -0.24f, 0.0f, 0.0f },
        Camera{ 58.0f }
    );

    ecs::entity::create("Ground")
        .set(
            Position3d{ 0.0f, -1.2f, 0.0f },
            Cuboid{ 22.0f, 0.25f, 18.0f },
            Color{ 30, 41, 64 }
        )
        .add<Static>();

    ecs::entity::create("Orange cuboid").set(
    ...
    ecs::entity::create("Blue cuboid").set(
    ...
    ecs::entity::create("Purple cuboid").set(
    ...
    ecs::entity::create("Emissive cuboid").set(
