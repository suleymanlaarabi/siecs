...
#define siecs_rest_deps_STATIC
#ifndef SIECS_REST_DEPS_H
#define SIECS_REST_DEPS_H
...
#elif SIECS_HAS_META
// Comment out this line when using as DLL
#define siecs_meta_deps_STATIC
#ifndef SIECS_META_DEPS_H
#define SIECS_META_DEPS_H
