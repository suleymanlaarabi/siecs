...
bake_test_case api_testcases[] = {
    ...
    {
        "cpp_only_methods",
        api_cpp_only_methods
    },
    {
        "cpp_custom_phase",
        api_cpp_custom_phase
    },
    {
        "cpp_system_interval",
    ...
    },
    {
        ...
        api_at_fini_captures_callable_state
    }
};
...
bake_test_case query_testcases[] = {
    ...
    {
        "owned_inherited_field_is_owned_by_default",
        query_owned_inherited_field_is_owned_by_default
    },
    {
        "each_receives_entity",
        query_each_receives_entity
    },
    {
        "each_defers_structural_mutation",
